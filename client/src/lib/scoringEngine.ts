 ...
 * 
 * The AI never touches this. Recommendation and confidence are
 * computed entirely from market data using fixed weighted factors.
 * 
 * Factors & Weights:
 *   Momentum (52W Position)   – 30%
 *   Market Cap Stability      – 25%
 *   Daily Trend               – 20%
 *   Volatility (Beta)         – 15%
 *   Sector Strength           – 10%
 * 
 * Each factor is scored 0–5. Weighted sum is normalized to 0–100.
 */
